            ...
            <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                <div class="max-w-[570px] mb-12 lg:mb-0">
                    ...
                    <p class="text-base text-body-color dark:text-gray-200 leading-relaxed mb-9">
                        If you have any question or out of your curosity Feel free to reach me.
                    </p>
                    <div class="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div class="w-full">
                            <h4 class="font-bold text-dark dark:text-gray-200 text-xl mb-1">Our Location</h4>
                    ...
                    <div class="flex mb-8 max-w-[370px] w-full">
                     ...
                     ">
                        ...
                        <div class="w-full">
                            <h4 class="font-bold text-dark dark:text-gray-200 text-xl mb-1">Phone Number</h4>
                            <p class="text-base text-body-color  dark:text-gray-300">(+880)1674729903</p>
                        </div>
                    </div>
                    <div class="flex mb-8 max-w-[370px] w-full">
                        <div class="
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color dark:text-gray-300">moazzemhb@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div class="bg-white dark:bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
                    ...
                    " x-on:submit.prevent="submitForm">
                        ...
                        <div class="mb-6">
                            <x-forms.input placeholder="Your phone (Optional)" name="phone" x-model="formData.phone" ::class="errors.phone ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
