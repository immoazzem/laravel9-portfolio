        ...
        <section x-data="{
            ...
            <div class="flex flex-wrap justify-center">
                <div class="w-full aspect-video relative z-20">
                    <div class="w-full h-full absolute top-0 p-3">
                        <!-- Thumbnail -->
                        <img
                    ...
                    <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-primary bg-opacity-0 z-10">
                        ...
                        >
                            <span class="absolute w-full h-full rounded-full top-0 right-0 bg-white bg-opacity-20 z-[-1] animate-ping delay-300 duration-100">
                            </span>
                            <!-- Play Icon -->
                            <svg
                                width="23"
